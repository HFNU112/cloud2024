...
import com.at.cloud.constant.ServiceConstant;
...
public class OrderController {
    ...
    public ResultData addPay(@RequestBody @Parameter PayDTO payDTO) {
        return restTemplate.postForObject(ServiceConstant.PAYMENT_BASE_URL + "/provider/pay/add", payDTO, ResultData.class);
    }
    ...
    public ResultData getPayById(@PathVariable("id") @Parameter Long id) {
        return restTemplate.getForObject(ServiceConstant.PAYMENT_BASE_URL + "/provider/pay/selectOne/" + id, ResultData.class, id);
    }

    @Operation(tags = "修改", summary = "修改", description = "服务消费修改支付")
    @GetMapping("/update")
    public ResultData updatePay(@RequestBody @Parameter PayDTO payDTO) {
        restTemplate.put(ServiceConstant.PAYMENT_BASE_URL + "/provider/pay/update", payDTO);
    ...
    public ResultData delete(@PathVariable("id") @Parameter Long id){
        restTemplate.delete(ServiceConstant.PAYMENT_BASE_URL + "/provider/pay/delete/"+id, id);
