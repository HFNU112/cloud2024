...
public class OrderController {
    ...
    public ResultData getPayById(@PathVariable("id") @Parameter Long id) {
        return restTemplate.getForObject(SystemConstant.PAYMENT_BASE_URL + "/provider/pay/selectOne/" + id, ResultData.class, id);
    }
    ...
    public ResultData delete(@PathVariable("id") @Parameter Long id){
        restTemplate.delete(SystemConstant.PAYMENT_BASE_URL + "/provider/pay/delete/"+id, id);
